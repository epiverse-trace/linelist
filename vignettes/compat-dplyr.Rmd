...
As such, we could expect it to work with linelist custom tidyselect-like function: `has_label()` but it's not the case since `pick()` currently strips out all attributes, including the `linelist` class and all tags.
